...
import com.sahu.quizapp.Adapter.UserAdapter
...
class SearchFragment : Fragment() {
    ...
    lateinit var mUser: MutableList<UserDetails>
    ...
    override fun onCreateView(
        ...
        mUser = ArrayList()
        userAdapter = context?.let { UserAdapter(it, mUser as ArrayList<UserDetails>, true) }
        recyclerView?.adapter = userAdapter
        view.search_edit_txt.addTextChangedListener(
            object : TextWatcher {
